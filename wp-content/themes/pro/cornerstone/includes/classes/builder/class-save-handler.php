...
class Cornerstone_Save_Handler extends Cornerstone_Plugin_Component {
    ...
    $old_version = get_post_meta($this->post_id, '_cornerstone_version', true );
    update_post_meta( $this->post_id, '_cornerstone_version', $this->plugin->version() );
      ...
      if ( $old_version ) {
        update_post_meta( $this->post_id, '_cornerstone_version', $old_version );
      } else {
        delete_post_meta( $this->post_id, '_cornerstone_version' );
      }
